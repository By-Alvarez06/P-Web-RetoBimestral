...
RF-02 & La plataforma debe permitir a la Comercializadora gestionar su catálogo completo, visualizar indicadores clave de rendimiento (KPIs) en tiempo real y configurar sus políticas de venta (porcentaje de comisión para vendedores).  \\ \hline
...
RF-04 & El sistema debe calcular las comisiones de la plataforma y procesar la gamificación al vendedor de manera automática, basándose en el porcentaje personalizado definido por cada Comercializadora.  \\ \hline
...
RF-06 & El sistema debe actualizar el inventario propio de una Tienda (InventarioTienda) automáticamente al entregar pedidos, y permitir al dueño del micromercado realizar ajustes físicos (CRUD) sobre su stock en percha.  \\ \hline
\end{tabular}
\end{table}
...
\begin{itemize}
    ...
    \item HU-02 (Comercializadora): Como administrador de la comercializadora, quiero visualizar en mi panel de control indicadores clave (KPIs) como cuentas por cobrar, tiendas abastecidas y alertas de stock, para tomar decisiones de negocio rápidamente.
    ...
    \item HU-05 (Tienda): Como dueño de micromercado, quiero consultar y ajustar manualmente el estado de mis inventarios locales (InventarioTienda) para mantener sincronizado mi stock físico frente a mermas o ventas al consumidor final.
    \item HU-06 (Comercializadora): Como administrador de la comercializadora, quiero poder configurar el porcentaje de comisión que ofrezco a los vendedores, para tener flexibilidad financiera según mi margen de ganancia.
\end{itemize}
...
Comerciali\-zadora & porcentaje\_comision & DecimalField & Porcentaje de comisión asignado a los vendedores (Ej: 10.00). Regla: $\ge$ 0. \\ \hline
...
Liquidacion\-Comerciali\-zadora & monto\_comision & DecimalField & Fee del vendedor (Calculado dinámicamente según el porcentaje\_comision de la Comercializadora). \\ \hline
...
\textbf{Pregunta 2 (Acoplamiento de Pagos):} Si el modelo de negocio permite comisiones variables por venta, ¿dónde se registra esta obligación y cómo se calcula?  \\
\textbf{Respuesta:} La clase Pedido posee la función interna \texttt{generar\_liquidacion()}. Esta función rastrea la Comercializadora dueña de los productos, obtiene su \texttt{porcentaje\_comision} personalizado y genera el registro \texttt{LiquidacionComercializadora} de forma desacoplada para mantener la trazabilidad contable.
